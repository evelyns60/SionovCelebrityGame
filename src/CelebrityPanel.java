...
public class CelebrityPanel extends JPanel implements ActionListener {
  ...
  public void actionPerformed(ActionEvent ae) {
    ...
    if (source instanceof JButton) {
      JButton currentButton = (JButton) source;
  ...
  public void addClue(String clue) {
    ...
    seconds = controller.getCelebrityGameSize() * 10;
    dynamicTimerLabel.setText(seconds + "");
  ...
  private void updateScreen() {
    String fieldText = guessField.getText();
    clueArea.append("\n You guessed: " + fieldText + "\n");
    boolean bol = controller.processGuess(fieldText);
    if (bol) {
